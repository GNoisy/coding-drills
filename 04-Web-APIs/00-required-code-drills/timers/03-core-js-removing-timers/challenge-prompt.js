...
function stopQuestionThree() {
  return clearTimeout(questionThree);
}

setTimeout(stopQuestionThree, 5000);
...
var questionFourTwo = setTimeout(stpQFour, 2000);

// create a timer that removes the "Part 2" timer after 1 second and also
// console logs out "Part 3" when it runs
function stpQFourThree () {
  console.log("Part 3");
  return clearTimeout(stpQFour);
}

setTimeout(stpQFourThree, 1000);
